...
from schemas import Task, TaskOut, UserTaskResponse
...
@router.get("/users/{user_id}/tasks-join", response_model=UserTaskResponse)
...
@router.get("/users/{user_id}/tasks-left-join", response_model=UserTaskResponse)
